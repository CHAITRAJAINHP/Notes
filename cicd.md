...
• Create a config.yaml file with terraform version and helm-chart version: service: service-name: version: helm-chart-version terraform: version: tf-version
...
How do you use GitLab templates to deploy infrastructure with Terraform and AWS EKS?

How do we authenticate AWS ECR repositories with ArgoCD?

How do we replicate AWS ECR Repositories across accounts?

How to set up a single GitLab server to run pipelines across different AWS accounts?

How do you manage secrets in CI/CD pipelines?

How do you remediate security vulnerabilities found while running the pipeline?
